...
let tests =
    testList "Feature 118 present-mode contract" [
        ...
        test "ViewerConfiguration.PresentMode mirrors the supplied ViewerOptions.PresentMode (config threading)" {
            ...
            let direct =
                thread { Title = "P"; InitialSize = size; PresentMode = ViewerPresentMode.DirectToSwapchain }

            let offscreen =
                thread { Title = "P"; InitialSize = size; PresentMode = ViewerPresentMode.OffscreenReadback }
