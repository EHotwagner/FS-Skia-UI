# Implementation Plan: Fixture (still boilerplate)

## Constitution Check

### Repository Governance Decisions

- **Template ownership**: Decide whether source, docs, samples, tests, Spec Kit assets, package policy, or command-surface changes must update the template.
...
(omitted — Template ownership still carries template boilerplate)
