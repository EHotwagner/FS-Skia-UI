...
validation_verdict:
  ...
  elapsed duration: Dev completed in ~2m52s without hang (Restore 33s, Build 63s, SampleContractSmoke 8s, Test 68s), exit code 0; all 15 routed gates passed sequentially (Status Ok each)
