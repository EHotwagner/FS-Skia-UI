...
| T011 | speckit-evidence-graph | high | EvidenceGraph | accepted | T011: task text matches speckit-evidence-graph; trigger_group=graph validation; matched_trigger=EvidenceGraph |
| T011 | speckit-evidence-audit | high | EvidenceAudit | accepted | T011: task text matches speckit-evidence-audit; trigger_group=evidence audit; matched_trigger=EvidenceAudit |
