...
- timestamp-utc: `2026-06-10T13:38:25.4023115+00:00`
- log-path: `/home/developer/projects/FS-Skia-UI/specs/091-wire-reconciler-render-path/readiness/logs/evidence-graph.txt`
- readiness-path: `/home/developer/projects/FS-Skia-UI/specs/091-wire-reconciler-render-path/readiness/task-graph.md`
...
- command: `./fake.sh build -t EvidenceGraph`
- direct-prerequisites: (none)
- timestamp-utc: `2026-06-10T13:49:41.7570046+00:00`
- log-path: `/home/developer/projects/FS-Skia-UI/specs/091-wire-reconciler-render-path/readiness/logs/evidence-graph.txt`
- readiness-path: `/home/developer/projects/FS-Skia-UI/specs/091-wire-reconciler-render-path/readiness/task-graph.md`
- verdict-category: `success`
- stale-build-restore-assumptions: (none)
...
- command: `./fake.sh build -t EvidenceGraph`
- direct-prerequisites: (none)
- timestamp-utc: `2026-06-10T13:49:44.2874544+00:00`
- log-path: `/home/developer/projects/FS-Skia-UI/specs/091-wire-reconciler-render-path/readiness/logs/evidence-graph.txt`
- readiness-path: `/home/developer/projects/FS-Skia-UI/specs/091-wire-reconciler-render-path/readiness/task-graph.md`
- verdict-category: `success`
- stale-build-restore-assumptions: (none)
...
- timestamp-utc: `2026-06-10T13:49:44.4091366+00:00`
- log-path: `/home/developer/projects/FS-Skia-UI/specs/091-wire-reconciler-render-path/readiness/logs/evidence-audit.txt`
- readiness-path: `/home/developer/projects/FS-Skia-UI/specs/091-wire-reconciler-render-path/readiness/evidence-audit.md`
- verdict-category: `success`
- stale-build-restore-assumptions: (none)
- failure-rule: `stale-build-restore-assumption`
- concurrent-fake-context: `unknown` until the runner records no other FAKE-backed command was active
