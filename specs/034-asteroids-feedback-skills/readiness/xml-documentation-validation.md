...
|--------------|------------|--------------|--------------------|-----------------------|--------|
| `src/Lib/Lib.fsproj` | `FS.Skia.UI` | `src/Lib/Library.fsi`, `src/Lib/KeyboardInput.fsi`, `src/Lib/AgentValidation.fsi` | `src/Lib/bin/Release/net10.0/FS.Skia.UI.xml` | `FS.Skia.UI.xml` | expected non-empty |
