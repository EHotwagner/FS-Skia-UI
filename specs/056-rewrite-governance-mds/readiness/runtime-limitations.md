# Runtime Limitations — Feature 056

This feature is a governance-documentation prose rewrite with **no runtime
...
- **.NET 10 desktop** — the runtime targets .NET 10 desktop hosts (Windows and
  Linux). This feature edits only governance prose under `.agents`/`.specify`.
...
None of these limitations are exercised or altered by feature 056.
