# Governance Risk Levels — Feature 090
...
- **Small** (framework-internal byte-identical): `Dev` + the failing-first
  Feature 090 tests. No broad rerun. Not this change.
...
incl. the Feature 090 recovery/dispatch/text-seam/responds-proof + governance
...
- **Small** — **required evidence**: `Dev` + the Feature 090 tests.
