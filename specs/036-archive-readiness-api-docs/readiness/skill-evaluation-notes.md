...
| T019 | generated guidance and evidence wording in template/reviewer docs | medium | `fs-skia-layout-readability` includes guidance/evidence wording rules beyond this feature's archive scope. | Load and apply only public guidance and evidence-honesty portions; no visual/runtime evidence is claimed. |
