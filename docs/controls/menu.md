...
<!-- BEGIN GENERATED: catalog-docs/menu -->
# Menu

- **Category:** navigation
- **Purpose:** Command menu selection.
- **API reference:** [FS.Skia.UI.Controls.Menu](../reference/fs-skia-ui-controls-menu.html)

[← Back to the controls catalog](catalog.html)
<!-- END GENERATED: catalog-docs/menu -->

## Overview

The **Menu** control is a `navigation`-category control in the FS.Skia.UI control suite.
Command menu selection. It requires the `items` attribute. It raises `onSelected`. Its accessibility role is `Menu`.
...
![Menu render-only preview](../img/controls/menu.png)

A deterministic **render-only** preview of **Menu** (320×160), produced through the
